...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "CGX7x1YqsqsCjoM6VO_v";
	private final static String CLIENT_SECRET = "RbX_4yRxYg";

	private final static String REDIRECT_URI = "http://localhost:8091/project/naverloginok";
